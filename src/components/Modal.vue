            ...
            <div class="modal-content">
              ...
              <div class="modal-body p-3">
                <div class="modal-input d-flex align-items-center mb-3">
                  <input type="text" v-model="todo.msg_task" :id='"todo_" + todo.id' class="w-100 border-0 border-info py-2 ps-2 text-secondary">
...
<script setup lang="ts">
    ...
    const showDescField = ref(false);
    const showPriorityField = ref(false);
    const showTagField = ref(false);
